...
! 
_function_70_TestSyscallParameterPassing:
	push	r14
	mov	r15,r14
	push	r13
	set	_RoutineDescriptor__function_70_TestSyscallParameterPassing,r1
	push	r1
	mov	79,r1
_Label_315:
	push	r0
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_78 = &_Global_arr1
	set	_Global_arr1,r1
	store	r1,[r14+-300]
!   Move address of _temp_78 [9900 ] into _temp_79
...
!   i = _temp_80 - 8		(int)
	...
	store	r1,[r14+-308]
! CALL STATEMENT...
!   _temp_81 = _StringConst_2
	set	_StringConst_2,r1
	store	r1,[r14+-288]
!   _temp_84 = _StringConst_2
	set	_StringConst_2,r1
	store	r1,[r14+-276]
...
!   Prepare Argument: offset=12  value=_temp_81  sizeInBytes=4
	load	[r14+-288],r1
	store	r1,[r15+4]
!   Prepare Argument: offset=16  value=_temp_82  sizeInBytes=4
	load	[r14+-284],r1
	store	r1,[r15+8]
!   Call the function
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if i == 1000 then goto _Label_92		(int)
	load	[r14+-308],r1
	mov	1000,r2
	cmp	r1,r2
	be	_Label_92
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if i == 2000 then goto _Label_100		(int)
	load	[r14+-308],r1
	mov	2000,r2
	cmp	r1,r2
	be	_Label_100
!	_Label_99	jmp	_Label_99
_Label_99:
! THEN...
	mov	79,r13		! source line 79
	mov	"\0\0TN",r10
! CALL STATEMENT...
!   _temp_101 = _StringConst_18
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if i == 5000 then goto _Label_110		(int)
	load	[r14+-308],r1
	mov	5000,r2
	cmp	r1,r2
	be	_Label_110
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_123 = &_Global_buff
	set	_Global_buff,r1
	store	r1,[r14+-144]
!   Move address of _temp_123 [0 ] into _temp_124
!     make sure index expr is >= 0
	mov	0,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if i == 6000 then goto _Label_126		(int)
	load	[r14+-308],r1
	mov	6000,r2
	cmp	r1,r2
	be	_Label_126
!	_Label_125	jmp	_Label_125
_Label_125:
! THEN...
	mov	122,r13		! source line 122
	mov	"\0\0TN",r10
! CALL STATEMENT...
!   _temp_127 = _StringConst_33
...
!   Call the function
	...
	call	print
! CALL STATEMENT...
!   _temp_135 = &_Global_buff
	set	_Global_buff,r1
	store	r1,[r14+-104]
!   Move address of _temp_135 [0 ] into _temp_136
!     make sure index expr is >= 0
	mov	0,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_139 = &_Global_buff
	set	_Global_buff,r1
	store	r1,[r14+-88]
!   Move address of _temp_139 [0 ] into _temp_140
!     make sure index expr is >= 0
	mov	0,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if i == 7000 then goto _Label_142		(int)
	load	[r14+-308],r1
	mov	7000,r2
	cmp	r1,r2
	be	_Label_142
!	_Label_141	jmp	_Label_141
_Label_141:
! THEN...
	mov	135,r13		! source line 135
	mov	"\0\0TN",r10
! CALL STATEMENT...
!   _temp_143 = _StringConst_41
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if i == 8000 then goto _Label_151		(int)
	load	[r14+-308],r1
	mov	8000,r2
	cmp	r1,r2
	be	_Label_151
!	_Label_150	jmp	_Label_150
_Label_150:
! THEN...
	mov	147,r13		! source line 147
	mov	"\0\0TN",r10
! CALL STATEMENT...
!   _temp_152 = _StringConst_48
...
! Routine Descriptor
! 
_RoutineDescriptor__function_70_TestSyscallParameterPassing:
	.word	_sourceFileName
	.word	_Label_163
	.word	0		! total size of parameters
...
! ===============  FUNCTION TestExec  ===============
! 
_function_69_TestExec:
	push	r14
	mov	r15,r14
	push	r13
	set	_RoutineDescriptor__function_69_TestExec,r1
	push	r1
	mov	61,r1
_Label_316:
	push	r0
...
!   _temp_242 = &_temp_241
	add	r14,-176,r1
	store	r1,[r14+-152]
!   _temp_242 = _temp_242 + 4
	load	[r14+-152],r1
	add	r1,4,r1
	store	r1,[r14+-152]
!   Next value...
!   _temp_244 = _StringConst_59
...
!   _temp_242 = _temp_242 + 4
	...
	store	r1,[r14+-152]
!   Next value...
!   _temp_245 = _StringConst_60
	set	_StringConst_60,r1
	store	r1,[r14+-140]
!   Data Move: *_temp_242 = _temp_245  (sizeInBytes=4)
	load	[r14+-140],r1
	load	[r14+-152],r2
	store	r1,[r2]
!   _temp_242 = _temp_242 + 4
	...
	store	r1,[r14+-152]
!   Next value...
!   _temp_246 = _StringConst_61
	set	_StringConst_61,r1
	store	r1,[r14+-136]
!   Data Move: *_temp_242 = _temp_246  (sizeInBytes=4)
	load	[r14+-136],r1
	load	[r14+-152],r2
	store	r1,[r2]
!   _temp_242 = _temp_242 + 4
	...
	store	r1,[r14+-152]
!   Next value...
!   _temp_247 = _StringConst_62
	set	_StringConst_62,r1
	store	r1,[r14+-132]
!   Data Move: *_temp_242 = _temp_247  (sizeInBytes=4)
	load	[r14+-132],r1
	load	[r14+-152],r2
	store	r1,[r2]
!   _temp_242 = _temp_242 + 4
	...
	store	r1,[r14+-152]
!   Next value...
!   _temp_248 = _StringConst_63
	set	_StringConst_63,r1
	store	r1,[r14+-128]
!   Data Move: *_temp_242 = _temp_248  (sizeInBytes=4)
	load	[r14+-128],r1
	load	[r14+-152],r2
	store	r1,[r2]
!   _temp_242 = _temp_242 + 4
...
!   make sure array has size 5
	...
	bvs	_runtimeErrorOverflow
	bne	_runtimeErrorWrongArraySize
!   Data Move: *_temp_240 = *_temp_249  (sizeInBytes=24)
	load	[r14+-124],r5
	load	[r14+-180],r4
	load	[r5],r1
	store	r1,[r4]
...
!   Next value...
	...
	store	r1,[r14+-100]
_Label_254:
!   Data Move: *_temp_252 = 0  (sizeInBytes=4)
	mov	0,r1
	load	[r14+-104],r2
	store	r1,[r2]
!   _temp_252 = _temp_252 + 4
	...
	add	r1,4,r1
	store	r1,[r14+-104]
!   _temp_253 = _temp_253 + -1
	load	[r14+-100],r1
	add	r1,-1,r1
	store	r1,[r14+-100]
!   if intNotZero (_temp_253) then goto _Label_254
	load	[r14+-100],r1
	cmp	r1,r0
	bne	_Label_254
!   Initialize the array size...
...
!   make sure array has size 2
	...
	bvs	_runtimeErrorOverflow
	bne	_runtimeErrorWrongArraySize
!   Data Move: *_temp_250 = *_temp_255  (sizeInBytes=12)
	load	[r14+-96],r5
	load	[r14+-120],r4
	load	[r5],r1
	store	r1,[r4]
...
!   Next value...
	...
	store	r1,[r14+-68]
_Label_260:
!   Data Move: *_temp_258 = 0  (sizeInBytes=4)
	mov	0,r1
	load	[r14+-72],r2
	store	r1,[r2]
!   _temp_258 = _temp_258 + 4
...
!   _temp_259 = _temp_259 + -1
	...
	add	r1,-1,r1
	store	r1,[r14+-68]
!   if intNotZero (_temp_259) then goto _Label_260
	load	[r14+-68],r1
	cmp	r1,r0
	bne	_Label_260
!   Initialize the array size...
...
!   make sure array has size 3
	...
	bvs	_runtimeErrorOverflow
	bne	_runtimeErrorWrongArraySize
!   Data Move: *_temp_256 = *_temp_261  (sizeInBytes=16)
	load	[r14+-64],r5
	load	[r14+-92],r4
	load	[r5],r1
	store	r1,[r4]
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_263 = &_Global_arr1
	set	_Global_arr1,r1
	store	r1,[r14+-56]
!   Move address of _temp_263 [9900 ] into _temp_264
!     make sure index expr is >= 0
	mov	9900,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   i = _temp_265 - 8		(int)
	...
	store	r1,[r14+-184]
! CALL STATEMENT...
!   _temp_266 = _StringConst_1
	set	_StringConst_1,r1
	store	r1,[r14+-44]
!   _temp_269 = _StringConst_1
	set	_StringConst_1,r1
	store	r1,[r14+-32]
...
!   Prepare Argument: offset=12  value=_temp_266  sizeInBytes=4
	load	[r14+-44],r1
	store	r1,[r15+4]
!   Prepare Argument: offset=16  value=_temp_267  sizeInBytes=4
	load	[r14+-40],r1
	store	r1,[r15+8]
!   Call the function
...
! Routine Descriptor
! 
_RoutineDescriptor__function_69_TestExec:
	.word	_sourceFileName
	.word	_Label_275
	.word	0		! total size of parameters
